...
export default defineConfig({
  resolve: {
    alias: {
      ...
      // `core` is the api package's declared reusable half (generated by
      // scripts/generate-core-surface.mjs) — the specifier the classifier can
      // treat as a core package while `@envoymesh/api` keeps tainting.
      "@envoymesh/api/core": resolve(rootDir, "packages/api/src/core.ts"),
