 ...
 *  any budget cuts. */
export declare const PLAN_FRAGMENT_PRIORITY = 1000;
/**
 ...
 */
export declare function buildPlanFragment(state: PlanState | undefined): ContextualUserFragment[];
/** The rendered plan fragment text. Stable + parseable. */
export declare function renderPlanText(state: PlanState): string;
