...
export declare const NOOP_MESH_SUBMITTER_ERROR: string;
/** A `MeshSubmitter` that throws on every call. */
export declare class NoopMeshSubmitter implements MeshSubmitter {
    submit(_input: SubagentInput, _signal: AbortSignal): Promise<SubagentResult>;
}
//# sourceMappingURL=noop-submitter.d.ts.map