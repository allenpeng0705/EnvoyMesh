 ...
 * doesn't set it.
 */
export declare function registerHooksFromConfig(registry: HookRegistry, specs: ReadonlyArray<HookHandlerSpec>): () => void;
//# sourceMappingURL=register-from-config.d.ts.map