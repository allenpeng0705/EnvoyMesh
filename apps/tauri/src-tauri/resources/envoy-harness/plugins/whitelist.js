...
const BUILTIN_PLUGINS = new Map([
    [auditLogPlugin.name, auditLogPlugin],
    [confirmToolPlugin.name, confirmToolPlugin],
 ...
 */
export const PLUGIN_WHITELIST = WHITELIST;
/**
 ...
 */
export function isWhitelistedPlugin(name) {
 ...
 */
export function getBuiltinPlugin(name) {
