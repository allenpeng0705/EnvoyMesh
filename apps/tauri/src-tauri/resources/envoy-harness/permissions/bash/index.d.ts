...
export { commandSemanticsValidation, destructiveCommandWarning, modeValidation, pathValidation, readOnlyValidation, sedValidation, };
 ...
 */
export declare const ALL_VALIDATORS: ReadonlyArray<BashValidator>;
/**
 ...
 */
export declare function validateBash(input: BashValidationInput): Promise<BashVerdict>;
