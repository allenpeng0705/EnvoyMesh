...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get navCoding => 'コーディング';

  @override
  String get codingHomePlaceholder =>
      'ホームのコーディングタスクがここに表示されます。準備ができたら + から開始できます。';
  ...
  @override
  String get codingSchedulesTitle => 'スケジュール';

  @override
  String get codingSchedulerActionFailed => '操作できませんでした。もう一度お試しください。';

  @override
  String get codingSchedulerListFailed => 'スケジュールを読み込めませんでした。もう一度お試しください。';

  @override
  String get codingSchedulerNew => '新しいタスクを始める';

  @override
  String get codingSchedulerEmpty =>
      'まだ予定はありません。タスクのメニューから予約するか、新しいタスクを始めてください。';

  @override
  String get codingSchedulerKindNew => '新しいタスクを始める';

  @override
  String get codingSchedulerKindContinue => 'このタスクを続ける';

  @override
  String get codingSchedulerDesc =>
      '決めた時刻にプロンプトを送ります。今のタスクを続けるか、新しいタスクを始めます。チーム作業ではありません。';

  @override
  String get codingSchedulerTitle => 'スケジュール';

  @override
  String get codingScheduleCreate => '新しいタスクを始める';
  ...
  @override
  String get codingOpenReview => 'レビューを開く';

  @override
  String get codingInviteReview => 'ピアにレビューを依頼';

  @override
  String get codingInviteReviewTitle => 'ピアにレビューを依頼';

  @override
  String codingInviteReviewDesc(String title) {
    return 'チャット招待を送り、ボンド済みの友だちが「$title」を読み取り専用レビューで開けるようにします。';
  }

  @override
  String get codingInviteReviewNoDirect => '直接ボンドの連絡先がありません。先に友だちとボンドしてください。';

  @override
  String get codingInviteReviewSend => '招待を送る';

  @override
  String get codingInviteReviewSending => '送信中…';

  @override
  String get codingInviteReviewSent => 'レビュー招待を送りました。';

  @override
  String get codingInviteReviewFailed => 'レビュー招待を送れませんでした。もう一度お試しください。';

  @override
  String get codingInviteReviewBondDenied => 'この連絡先にはレビュー招待を送れません。';

  @override
  String get codingInviteReviewOpenOnOwnerHome =>
      'このタスクをレビューするには所有者のホームノードで開いてください。';

  @override
  String get codingReviewOnlyBanner => 'レビューのみ — タイムラインと変更を表示。ツールと取り消しは無効です。';

  @override
  String get codingHeartbeatAdd => 'このタスクを予約…';

  @override
  String get codingHeartbeatAddTitle => 'このタスクを予約';

  @override
  String codingHeartbeatAddDesc(String title) {
    return '決めた時刻に「$title」へプロンプトを送ります。今のタスクを続けます。新しいタスクは作りません。';
  }
  ...
  @override
  String get codingHeartbeatSaved => '保存しました。';

  @override
  String get codingHeartbeatSaveFailed => '保存できませんでした。もう一度お試しください。';
  ...
  @override
  String get mePublicAccess => '直接ホームアドレス';

  @override
  String get mePort => 'ポート';

  @override
  String get mePublicAccessSaved => '直接アドレスを保存しました — 再接続中…';
  ...
  @override
  String get mePublicIpLabel => 'ホスト（Tailscale・VPN・またはパブリック IP）';

  @override
  String get mePublicIpHint => '例: 100.64.1.2 または home.example.com';

  @override
  String get mePublicIpHelp =>
      '自宅PCの Tailscale/VPN IP、または到達可能なホスト名を入力します。\nEnvoyGo は WebSocket で host:port（既定 3030）に接続します — 電話では SSH を使いません。\nLAN の次、リレーの前に試行します。';
  ...
  String get pairingFailedHomeTimeout =>
      'ペアリングを完了できませんでした — ホームのパソコンが時間内に応答しませんでした。EnvoyAI を開いたままオンラインにし、新しい QR をスキャンしてください。';

  @override
  String get pairingFailedHomeUnreachable =>
      'ホームのパソコンに接続できません。同じ Wi‑Fi に接続するか、ホームアプリがリレー接続を表示してから、新しい QR をスキャンしてください。';

  @override
  String get pairingFailedTokenExpired =>
      'この QR は期限切れか無効です。ホームの所有者に新しいペアリング QR を表示してもらってください。';
  ...
  @override
  String get ehReviewOnly => 'タスク検出 · 確認のみ';
