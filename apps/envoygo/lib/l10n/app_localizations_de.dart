...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String get codingHomePlaceholder =>
      'Coding-Aufgaben von Ihrem Home erscheinen hier. Starten Sie eine über +, wenn Sie bereit sind.';
  ...
  @override
  String get codingOpenReview => 'Öffnen zur Prüfung';

  @override
  String get codingInviteReview => 'Peer zur Prüfung einladen';

  @override
  String get codingInviteReviewTitle => 'Peer zur Prüfung einladen';

  @override
  String codingInviteReviewDesc(String title) {
    return 'Sende eine Chat-Einladung, damit ein gebondeter Freund „$title“ im Nur-Lese-Prüfmodus öffnen kann.';
  }

  @override
  String get codingInviteReviewNoDirect =>
      'Noch keine direkt gebundenen Kontakte. Binde zuerst einen Freund.';

  @override
  String get codingInviteReviewSend => 'Einladung senden';

  @override
  String get codingInviteReviewSending => 'Wird gesendet…';

  @override
  String get codingInviteReviewSent => 'Prüfeinladung gesendet.';

  @override
  String get codingInviteReviewFailed =>
      'Prüfeinladung konnte nicht gesendet werden. Bitte erneut versuchen.';

  @override
  String get codingInviteReviewBondDenied =>
      'Dieser Kontakt kann keine Prüfeinladung erhalten.';

  @override
  String get codingInviteReviewOpenOnOwnerHome =>
      'Öffne dies auf dem Home-Knoten des Besitzers, um die Aufgabe zu prüfen.';
  ...
  @override
  String get socialContextPhone => 'Auf diesem Telefon';

  @override
  String get socialContextHome => 'Zuhause';

  @override
  String get socialContextSheetTitle => 'Soziale Identität';

  @override
  String get socialContextPhoneSubtitle =>
      'Eigenständige Mesh-Persona auf diesem Gerät';

  @override
  String get socialContextHomeSubtitle =>
      'Ihren Heimknoten nutzen (Thin Client)';

  @override
  String get socialContextNoHome =>
      'Noch kein Zuhause gekoppelt — koppeln Sie einen Computer für Social Zuhause.';

  @override
  String get socialHomeOnlyTitle => 'Nur mit Zuhause';
  ...
  @override
  String get crossPersonaSuggestionsTitle => 'Auch auf diesem Telefon kennen?';

  @override
  String get crossPersonaSuggestionsSubtitle =>
      'Personen, mit denen Sie schon Zuhause verbunden sind. Hallo startet eine separate Bindung auf diesem Telefon — Chats bleiben getrennt.';

  @override
  String get crossPersonaFromHome => 'Zuhause verbunden';

  @override
  String get crossPersonaFromPhone => 'Auf diesem Telefon verbunden';

  @override
  String get crossPersonaSayHello => 'Hallo sagen';

  @override
  String get crossPersonaDismiss => 'Verwerfen';

  @override
  String get crossPersonaHelloSent =>
      'Hallo gesendet. Sie müssen auf dieser Identität noch annehmen.';

  @override
  String get crossPersonaHelloFailed => 'Hallo konnte nicht gesendet werden.';
  ...
  @override
  String get mePublicAccess => 'Direkte Heimadresse';
  ...
  String get mePublicAccessSaved =>
      'Direkte Adresse gespeichert — verbinde neu…';
  ...
  @override
  String get chatsSectionHomeContacts => 'Zuhause-Kontakte';

  @override
  String get chatsSectionPhoneContacts => 'Auf diesem Telefon';
  ...
  String get peopleSearchReportHint =>
      'In der Nähe, im Internet und über Relays gesucht.';

  @override
  String get peopleSearchRelayUnreachable =>
      'Die Relays haben nicht geantwortet — das Netzwerk blockiert sie möglicherweise, oder das andere Gerät ist offline.';
  ...
  @override
  String get profileHobbiesHint => 'z. B. Kochen, Wandern';

  @override
  String get profileKnowledgeHint => 'z. B. Heimnetzwerk';
  ...
  @override
  String get mePublicIpLabel => 'Host (Tailscale, VPN oder öffentliche IP)';

  @override
  String get mePublicIpHint => 'z. B. 100.64.1.2 oder home.example.com';

  @override
  String get mePublicIpHelp =>
      'Tailscale-/VPN-IP Ihres Heimrechners oder erreichbarer Hostname.\nEnvoyGo verbindet per WebSocket host:port (Standard 3030) — kein SSH auf dem Telefon.\nNach LAN, vor Relay.';
  ...
  @override
  String get chatMoreAttach => 'Anhang hinzufügen';

  @override
  String get chatAttachPhoto => 'Foto';

  @override
  String get chatAttachFile => 'Datei';

  @override
  String get chatShareFromVault => 'Aus dem Tresor teilen';

  @override
  String get chatNoVaultFilesToShare => 'Keine Tresordateien zum Teilen';

  @override
  String get chatAttachFilesAgent => 'Dateien anhängen';
  ...
  String chatFileTooLarge(String name, String maxMb) {
    return '$name: Datei zu groß (max. $maxMb MiB)';
  }

  @override
  String get chatAgentAttachOwnerOnly =>
      'Nur der Knotenbesitzer kann Dateien an Agent-Chats anhängen.';

  @override
  String get chatAttachHomeFile => 'Heimdatei';

  @override
  String get chatAttachPhoneFile => 'Telefondatei';
  ...
  @override
  String get ehReviewOnly => 'Aufgabe erkannt · nur Prüfung';
  ...
  @override
  String get welcomeContinue => 'Fortfahren';

  @override
  String get welcomeSlide1Title => 'Willkommen bei EnvoyGo';

  @override
  String get welcomeSlide1Body =>
      'EnvoyGo ist der Telefon-Begleiter für EnvoyMesh — Chat, Inhalte und Fernzugriff, während Ihr Zuhause auf dem Computer bleibt.';

  @override
  String get welcomeSlide2Title => 'EnvoyMesh ist Ihr Zuhause';

  @override
  String get welcomeSlide2Body =>
      'Installieren Sie EnvoyMesh auf einem Mac oder Windows-PC. Dieser Computer ist Ihr privater Heimknoten — Identität, Bindungen und KI bleiben bei Ihnen.';
  ...
  String get welcomeSlide3Body =>
      'Öffnen Sie EnvoyMesh am Computer und zeigen Sie den Kopplungs-QR. In EnvoyGo: Ich → Koppeln und scannen. Familieneinladungen funktionieren genauso.';

  @override
  String get welcomeSlide4Title => 'Telefonbereit, vom Zuhause betrieben';
  ...
  @override
  String get onboardingProfileTitle => 'Profil einrichten';

  @override
  String get onboardingProfileLede =>
      'Name und Interessen sind es, worüber andere Sie finden — in der Nähe und über das Internet. Jederzeit änderbar unter Me → Profil bearbeiten.';

  @override
  String get onboardingProfileInterestsHint =>
      'Fügen Sie einige Interessen hinzu — danach suchen andere.';

  @override
  String get onboardingProfileSkipHint =>
      'Sie können überspringen. Solange keine Interessen hinterlegt sind, ist dieses Telefon nur über seine Netzwerkadresse auffindbar, nicht über Themen.';

  @override
  String get onboardingProfileNameRequired =>
      'Bitte einen Anzeigenamen angeben oder überspringen.';

  @override
  String get setupGuideIntro =>
      'EnvoyGo spricht mit EnvoyMesh auf Ihrem Computer. Einmal koppeln, dann Social, Terminal und Wissen vom Telefon nutzen.';
  ...
  String get setupGuideStep1Body =>
      'Sie brauchen einen Mac oder Windows-PC im gleichen Netzwerk (oder per Relay erreichbar). Das wird Ihr EnvoyMesh-Heimknoten.';

  @override
  String get setupGuideStep2Title => 'EnvoyMesh herunterladen und installieren';
  ...
  String get setupGuideStep3Body =>
      'Öffnen Sie in der Desktop-EnvoyMesh die Kopplung (oder laden Sie ein Familienmitglied ein). Lassen Sie den QR sichtbar.';

  @override
  String get setupGuideStep4Title => 'Mit EnvoyGo scannen';

  @override
  String get setupGuideStep4Body =>
      'Gehen Sie in dieser App zu Ich → Koppeln (oder tippen Sie unten auf Koppeln). Kamerazugriff erlauben, dann QR scannen. Sie können auch einen envoy://-Link einfügen.';

  @override
  String get setupGuideStep5Title => 'Sie sind verbunden';

  @override
  String get setupGuideStep5Body =>
      'Nach der Kopplung zeigt Social Zuhause-Chats und Inhalte. Das Wolkensymbol zeigt Verbunden, wenn der Heimknoten online ist.';

  @override
  String get setupGuidePhoneOnlyTitle => 'EnvoyGo ohne Zuhause';
