...
import { printHelp } from "./args-help.js";
...
// Re-exported *and* imported: `discovery-dashboard.ts` imports `printHelp` from
// `./args.js`, and the `--help` branch inside `parseNodeArgs` calls it directly.
// A re-export alone would not put it in this module's scope.
export { printHelp };
