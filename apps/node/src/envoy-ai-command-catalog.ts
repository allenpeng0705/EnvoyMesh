...
export const ENVOY_AI_FEATURE_EXPAND_PROMPTS = {
  ...
  team:
    ...
    "2. Under Office LAN, optionally Generate/paste a fleet token (or leave empty for open LAN on a trusted office Wi‑Fi). Then click Enable office LAN team. That turns on Join Agent Network, LAN auto-bond, auto-join Agent Network, and lan-fast discovery.\n" +
