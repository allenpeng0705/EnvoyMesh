...
export const ENVOY_AI_FEATURE_EXPAND_PROMPTS = {
  ...
  team:
    ...
    "2. Under Office LAN, set or Generate a fleet token (Copy and share it). Then click Enable office LAN team. That turns on Join Agent Network, LAN auto-bond, auto-join Agent Network, and lan-fast discovery.\n" +
