...
function buildSoulMd(): string {
  return [
    ...
    "Ext Agent, HomeClaw, Hermes, OpenHuman, bridge, super channel,",
    "chains, Agent Network, chain handoff, knowledge queries, social intros,",
    "EnvoyAI, trust tiers, bonds, discovery, mDNS, relay, vault, library,",
    "terminals, EnvoyMesh Mobile, Capacitor, QR pairing, data transfer,",
    "agent triggers, agent approvals, agent mode, agent style, agent memory.",
    "",
...
function buildAgentsMd(): string {
  return [
    ...
    "## Product Knowledge",
    "",
    "Read `ENVOYMESH_GUIDE.md` for the full product guide — features, UI steps,",
    "settings, Ext Agent, mobile, chains, trust tiers, and troubleshooting.",
