/** Call signaling E2E — callee decline delivers call.reject to caller via chat. */
...
describe("E2E call signaling — decline", () => {
  beforeAll(async () => {
  ...
  it("delivers call.reject on chat protocol", async () => {
    ...
    const sendChatSpy = vi.spyOn(callee.mesh, "sendChat");
