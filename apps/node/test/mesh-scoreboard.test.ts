 ...
 * known contact owner key, federation-evidence floor, local-evidence gate
 * (`pending`, never adopted blind), and strict pass-rate comparison before a
 * pulled rule joins the local scoreboard.
 */
...
const LOCAL_OWNER = generateOwnerIdentity()
...
function makeDeps(overrides: Partial<PullScoreboardRuleDeps> = {}): PullScoreboardRuleDeps & {
