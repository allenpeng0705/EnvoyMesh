export const agentNetworkSettingsMessages = {
  ...
  membership: {
    ...
    strengthGroup_analytical: "Analytical",
    strengthGroup_stem: "STEM",
    strengthGroup_language: "Language",
    strengthGroup_creative: "Creative",
    strength_research: "Research",
    strength_analysis: "Analysis",
    strength_reasoning: "Reasoning",
    strength_mathematics: "Mathematics",
    strength_physics: "Physics",
    strength_coding: "Coding",
    strength_engineering: "Engineering",
    strength_writing: "Writing",
    strength_summarization: "Summarization",
    strength_translation: "Translation",
    strength_creative: "Creative",
    strength_design: "Design",
    save: "Save profile",
    saving: "Saving…",
