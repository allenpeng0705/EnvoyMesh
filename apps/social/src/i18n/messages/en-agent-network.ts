export const agentNetworkSettingsMessages = {
  ...
  membership: {
    ...
    presetTitle: "Quick setup — skill preset",
  ...
  testNetwork: {
    heading: "Test Agent Network",
    desc: "Run a no-spend check against the current worker pool. No real jobs, model spend, or reputation changes.",
    noSpend: "Simulation — no work sent, no model spend, no reputation changes.",
    modeLabel: "Scenario",
    modeReadiness: "Network readiness",
    modeReadinessHint: "Lease + membership snapshot only — no ranking.",
    modeDryPlan: "Dry-plan (goal optional)",
    modeDryPlanHint: "Uses live strategy ranking (findAgentNetworkWorkersRanked) — still no work sent.",
    modeFailover: "Failover (worker offline)",
    modeFailoverHint: "Light label simulation: shows a likely replacement worker, not a real fault inject.",
    modeRecovery: "Recovery (assigner restarted)",
    modeRecoveryHint: "Light label simulation: synthetic RECOVERING note — does not restart a real node.",
    goalLabel: "Dry-run goal",
    goalPlaceholder: "e.g. Summarize last week’s notes",
    run: "Run simulation",
    running: "Running…",
  },
  workersStatus: {
    ...
    leasePublishing: "Worker lease: publishing",
  ...
  setupSponsorFriend: {
    ...
    statusAlreadyBonded: "Complete — you're already connected to this contact",
