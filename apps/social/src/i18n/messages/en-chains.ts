export const chainsMessages = {
  ...
  start: {
    ...
    selectTeamPreviewNote: "Scores blend skills, model freshness, spend posture, throughput, and LAN fit. Only online, opted-in contacts are selectable. Checked workers form the launch pool.",
