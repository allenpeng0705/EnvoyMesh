...
export const terminalMessages = {
  ...
  howTo: {
    ...
    before3: "Agent mode (plain shell only) proposes commands for review; Manual mode types straight into the shell.",
    shellTitle: "Example 1 — Plain shell",
    shellMode: "Path: + (new terminal). Good for logs, git, and quick commands on the home machine.",
    shellGoal: "Goal: “Check disk space and follow a log file.”",
    shellFlowTitle: "Step by step",
    shellStep1: "Open Terminals in the sidebar.",
    shellStep2: "Click + to create a new shell session.",
    shellStep3: "Type commands in the panel (or switch to Agent mode and describe the task, then confirm proposed commands).",
    shellStep4: "Close the session with × when finished — running commands stop.",
    shellResult: "Result: a remote shell on your home node, controlled from Social.",
    envoyTitle: "Example 2 — Envoy harness TUI",
    envoyMode: "Path: Envoy button. Always chooses a project folder first.",
    envoyGoal: "Goal: “Open the Envoy harness UI for my app repo and use the EHUI command rail.”",
    envoyFlowTitle: "Step by step",
    envoyStep1: "Click Envoy in the Terminals header.",
    envoyStep2: "Pick the project folder on the home machine (or change Path later on that session).",
    envoyStep3: "Wait until the Envoy TUI session appears in the list and select it.",
    envoyStep4: "Use the EHUI command bar above the terminal when it appears for structured harness actions.",
    envoyStep5: "Start another Envoy session anytime with Envoy again — each pick can use a different folder.",
    envoyResult: "Result: harness work stays tied to a project folder on the home node.",
    piTitle: "Example 3 — Pi coding TUI",
    piMode: "Path: Pi button. Coding agent TUI in a chosen project folder.",
    piGoal: "Goal: “Open Pi on my repo and stop it cleanly when done.”",
    piFlowTitle: "Step by step",
    piStep1: "Click Pi in the Terminals header.",
    piStep2: "Choose the project folder; Pi starts in that directory.",
    piStep3: "Select the π session in the list; use Path on the row to change folders later.",
    piStep4: "Stop with × — Pi does not auto-restart after you close it.",
    piResult: "Result: one Pi coding session per project start, fully under your control.",
    tip: "Tip: Envoy and Pi need a reachable home node and a real folder path. Plain + shells are enough for everyday commands. Use How it works anytime from this header.",
    done: "Got it",
  },
  agent: {
    manual: "Manual",
