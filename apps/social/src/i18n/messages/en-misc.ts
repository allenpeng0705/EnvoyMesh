...
export const knowledgeViewMessages = {
  ...
  embedGate: {
    ...
    bodyNeeded:
      "Knowledge Browse and Ask need a local embedding model. Download once — it runs in the background.",
    bodyDownloading:
    ...
    stripNeeded: "Knowledge needs an embedding model — download or open Setup.",
    stripDownloading: "Downloading embedding model…",
    stripError: "Embedding download failed — retry in Setup.",
