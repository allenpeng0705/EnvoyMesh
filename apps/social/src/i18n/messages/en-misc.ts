...
export const browserViewMessages = {
  ...
  idleHintMySite: "Your Profile, Blog, and PhotoWall are created automatically. Use New… to edit them.",
  mySite: {
    title: "My site",
    intro: "Open your published pages, or create / update them without typing a URL.",
    openLabel: "Open",
  ...
  idleHintPublish: "Use New… to publish your own Profile, Blog, or photos.",
  modes: "Browser modes",
  modeBrowse: "Browse",
  modeBazaar: "Bazaar",
  bazaar: {
    ...
    feedHeading: "From your contacts",
    feedEmpty: "No published posts yet. When bonded contacts publish, they show up here.",
    shelvesHeading: "Contact shelves",
    shelvesEmpty: "Bond with contacts to see their published sites here.",
    topicHeading: "Discover by topic",
