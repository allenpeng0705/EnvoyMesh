...
export const browserViewMessages = {
  ...
  author: {
    ...
    binaryLede: "Add a file, set visibility, then publish to your mesh site.",
    articleTitle: "Headline",
    story: "Story",
    caption: "Caption (optional)",
    captionPlaceholder: "A short story under the photo…",
    pickerHint: "Choose a template to publish to your mesh site.",
    ...
    sectionHint: "Creates envoy://…/{slug}/ — share the link or discover via topic search.",
