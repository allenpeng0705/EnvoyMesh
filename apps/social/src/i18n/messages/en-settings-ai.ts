export const aiSettingsMessages = {
  ...
  aiEngine: {
    ...
    piAutoRunTrust: "Off — always show preview",
    piAutoRunTrustDesc:
      "Auto-run is off: every tool action shows a preview and still requires confirmation (same gate as Always confirm today).",
