export const aiSettingsMessages = {
  ...
  aiEngine: {
    ...
    projectFolderUnsupported:
      "Set a folder after you select Codex, Claude Code, Cursor, Aider, or MiniMax as the external agent.",
    browseFolder: "Browse…",
    applyFolder: "Set",
    clearFolder: "Clear",
    browsingFolder: "Browsing…",
    loadingFolder: "Loading…",
    selectFolder: "Select this folder",
    folderRoots: "Drives",
    folderEmpty: "No subfolders",
    folderPickerUnavailable:
      "Folder picker needs the desktop app or a connected home node.",
    ...
    piAutoRunPolicy: "Permission policy",
    piAutoRunAlwaysConfirm: "Ask every time (recommended)",
    piAutoRunAlwaysConfirmDesc: "Every tool action surfaces as a confirm dialog.",
    piAutoRunSafeOnly: "Safe default",
    piAutoRunSafeOnlyDesc:
      "Auto-allow read-only / safe operations; confirm writes, edits, and shell.",
    piAutoRunTrust: "Full access (no ask)",
    piAutoRunTrustDesc:
      "Auto-approve every tool with no prompts — including write/edit/bash. Only use this for tasks you fully trust.",
  ...
  envoyLocal: {
    ...
    manage: "Manage Envoy Local…",
    manageTitle: "Envoy Local",
    closeManage: "Close",
  ...
  rag: {
    ...
    movedToKnowledgeDesc:
      "Browse, Ask, Plugins (Obsidian / Notion MCP), and index setup live under Knowledge. Chat models and Ext Agent stay here.",
    ...
    // Knowledge Setup card sections (Knowledge → Setup)
    sectionGeneral: "General",
    sectionGeneralDesc: "Turn vault RAG on or off and choose how snippets are retrieved.",
    sectionEmbedding: "Embedding",
    sectionEmbeddingDesc:
      "Choose how vault text is turned into vectors. Independent from the chat model — change chat without rebuilding embeddings.",
    sectionContext: "Prompt context",
    sectionContextDesc: "How much recent chat and vault context is injected into each AI prompt.",
    sectionIndex: "Indexing",
    sectionIndexDesc: "Chunking and size limits for vault files when building the vector index.",
    sectionPaths: "Knowledge paths",
    sectionPathsDesc: "Which vault folders count as public vs private knowledge.",
    sectionExternal: "External sources",
    sectionExternalDesc: "Optional MCP search alongside the local vault (owner Envoy AI only).",
    embeddingIndependentBanner:
      "Embedding is configured separately from the chat model. Default is Envoy Local (auto-download). Switch to a cloud or Ollama embedding API anytime without changing chat.",
    embeddingLocalInstall: "Install & start Envoy Local embedder",
    embeddingLocalInstalling: "Installing…",
    embeddingLocalStop: "Stop embedder",
    ...
    testEmbeddingFailToast: "Embedding test failed: {error}",
    testEmbeddingOkDetail:
      "OK — {dimensions} dims, {latencyMs} ms · {modelKey} ({mode})",
    testEmbeddingFailDetail: "Failed: {error} · mode {mode} · {endpoint}",
    indexStateIdle: "Idle",
    indexStateIndexing: "Indexing",
    indexStateReady: "Ready",
    indexStateError: "Error",
    indexMetricTracked: "Tracked files",
    indexMetricEmbedder: "Embedder",
    indexMetricLastRun: "Last run",
  },
  profileMedia: {
  ...
  cost: {
    ...
    loadError: "Couldn’t load cost summary. Try again.",
  ...
  aiBots: {
    heading: "AI Character Bots",
    desc: "Create custom AI characters with unique personalities. They appear in your chat list and sync to all your devices automatically.",
    empty: "No bots yet. Click “Add Bot” to create one.",
    saved: "Bot added! It will appear in your chat list.",
    name: "Bot name",
    namePlaceholder: "e.g. Luna the Librarian",
    nameTaken: "A bot named “{name}” already exists.",
    ...
    descPlaceholder: "My girlfriend · music & travel",
    descHint: "One short line for the chat list. Leave blank to auto-fill from the personality.",
    ...
    deleteConfirmMessage: "“{name}” will be removed from this node and all paired devices.",
    deleteFailed: "Couldn’t delete bot: {error}",
    disabled: "(disabled)",
  },
} as const;
