...
export function ChainStartDialog({
  ...
  }, [assignmentMode, assignerPeerId, goal, hasWorkers, iterationMaxRounds, iterationJudgeMode, extendMaxStepsPerRound, nodeService, onClose, onStarted, preview, selectedPeerIds, showToast, t]);
