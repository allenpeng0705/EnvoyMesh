...
export const KNOWN_EMBEDDING_MAX_INPUT_TOKENS = {
    "embo-01": 4096,
    "text-embedding-3-small": 8191,
    "text-embedding-3-large": 8191,
    "nomic-embed-text": 8192,
};
export function resolveEmbeddingMaxInputTokens(embedding, resolvedModelName) {
 ...
 */
export function estimateEmbeddingTokenCount(text) {
...
export function truncateTextForEmbedding(text, maxInputTokens) {
...
export function maxVaultChunkCharsForEmbeddingTokens(maxInputTokens) {
    if (maxInputTokens <= 0)
        return 200;
    let lo = 200;
...
//# sourceMappingURL=ai-embedding-limits.js.map