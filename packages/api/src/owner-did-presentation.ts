...
function decodePemBody(publicKeyPem: string): Uint8Array {
...
export function ed25519RawPublicKeyFromSpkiPem(publicKeyPem: string): Uint8Array {
...
export function deriveDidKeyFromEd25519PublicKey(rawPublicKey: Uint8Array): string {
...
export function parseDidLookupInput(raw: string): ParsedDidLookupInput {
...
export function didKeysMatch(left: string, right: string): boolean {
