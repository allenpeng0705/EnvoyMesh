...
// From `@envoymesh/protocol`, not `@envoymesh/api`: this package is the shared
// core for the node app *and* the harness, and importing the product surface
// made every module in it `product-bound` — which is why nothing reusable could
// use it. See `protocol/src/ext-agent-contract.ts`.
import type {
  HomeFsPreviewKind,
...
/** Agents that use a local project folder as cwd — see @envoymesh/protocol. */
export {
